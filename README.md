# ✨ ZeOS: Mein eigenes minimales Linux

![LFS Logo](https://linuxfromscratch.org/images/lfs-logo.png)

Willkommen zu ZeOS. Inoffiziell: Ziemlich Extrem Ödes System. Ich baue alles selbst. Weil ein echter Sysadmin weiß, was im Keller läuft. 😂🔧
...
- **Challenge:** Ich will mir später sagen können: Ich bin ein **Macher** 🦸🏻💪💪.
- **Profil:** Ich hebe mich von anderen Bewerber:innen (Ausbildung zum Fachinformatiker für Systemintegration) ab. 🚀
...
## 📑 Berichte von meinem Fortschritt (Kapitel 2–11)

Ich dokumentiere sauber. Wo Compiler spinnen. Und wie ich sie gezähmt habe. :hammer_and_wrench:
...
## 🔧 Build-Highlights und wichtige Pakete

Kuratiert für Systemintegration (ich als zukünftiger IT-ler) . Nur das, was hilft. Keine Romane. 🧰
...
- **Kernel & Headers:** [[5.4 Linux-6.16.1 API Headers.md]], [[10.3. Linux-6.16.1 – Installation des Kernels.md]]
- **Devices & Module:** [[9.3. Overview of Device and Module Handling.md]], [[9.4. Geräteverwaltung (Managing Devices).md]], [[8.76. Udev from Systemd-257.8.md]]
- **Netzwerk & Locale:** [[9.5. General Network Configuration.md]], [[9.7. Configuring the System Locale.md]]
- **Python & Ökosystem:** [[7.10. Python-3.13.7.md]], [[8.51. Python-3.13.7.md]], [[8.52. Flit-Core-3.12.0.md]], [[8.53. Packaging-25.0.md]], [[8.54. Wheel-0.46.1.md]], [[8.55. Setuptools-80.9.0.md]]
- **Sonstiges Nützliches:** [[8.41. Inetutils-2.6.md]], [[8.78. Procps-ng-4.0.5.md]], [[7.12. Util-linux-2.41.1.md]], [[8.79. Util-linux-2.41.1.md]], [[9.8. Erstellen der inputrc Datei.md]], [[9.9. Erstellen der shells Datei.md]], [[8.83. Stripping and Debugging Symbols.md]]

---

## 🖼️ Bilder und Snapshots

Screenshots und Logs belegen den Fortschritt. Nur das Nötigste. Dafür sauber.

- **Host-Infos:** [[kernel-version-host.png]], [[kernel-detail-host.png]], [[lsb_release_ergebnis.png]]
- **Kapitel-Snapshots:** [[kapitel-3-überprüft.png]], [[logs-von-kapitel-5.png]], [[logs-von-kapitel-6.png]], [[snapshots.png]]
- **Setup-Schritte:** [[4.2_Erstellen_eines_eingeschränkten_Verzeichnislayouts.png]], [[4.3_Hinzufügen_des_LFS-Benutzers.png]], [[4.3_Vergeben_der_Besitzrechte.png]], [[4.4_Einrichtung_der_Umgebung.png]]
...
- **Kernel & Boot:** [[10.3. Linux-6.16.1 – Installation des Kernels]], [[Using GRUB to Set Up the Boot Process with UEFI]]
